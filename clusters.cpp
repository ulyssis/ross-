...
unsigned int numCR = 300;
	...
	PoolofNeighborhoods Pool_MotherGroups(numCR,Neighbors());
	PoolofNeighborhoods Pool_MotherGroups_copy(numCR,Neighbors());

	PoolofNeighborhoods backuppool_original_group(numCR,Neighbors());//store original group in the phaseII
