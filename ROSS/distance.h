...
namespace Metrics{
	...
	class Distance : Distance_Policy	//Distance_Policy is derived class of Distance!
	{
	...
	public:
		...
		double similarity(typename Distance_Policy::vector_type x, typename Distance_Policy::vector_type y)//typename的作用就是告诉c++编译器，typename后面的字符串为一个类型名称，而不是成员函数或者成员变量
		{																								//http://blog.csdn.net/yc_8301/archive/2009/07/30/4392955.aspx		
